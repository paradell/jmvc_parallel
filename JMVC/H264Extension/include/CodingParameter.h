...
//~JVT-W080 
  ...
  Bool                            isRTP		              ()              const    { return m_uiRTP; }
  Bool                            isParallel              ()              const    { return m_uiParallel; }
  Bool                            isDebug                 ()              const    { return m_uiDebug; }
  Bool                            isVerbose               ()              const    { return m_uiVerbose; }
...
//Transmission
	std::string              getIPAdress       ()              const   { return m_cIpAdress; }
	UInt                            getUDPPort        ()              const   { return m_cPort; }
//TMM_WP
  UInt getIPMode()                  const { return m_uiIPMode; }
  UInt getBMode()                   const { return m_uiBMode; }
//TMM_WP
