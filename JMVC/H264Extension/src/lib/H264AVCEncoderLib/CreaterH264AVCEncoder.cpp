                                ...
                                PicBufferList*           apcPicBufferUnusedList )
{
	...
	apcPicBufferUnusedList->push_back( apcReconstructPicBuffer);
  RNOK( m_pcPicEncoder  ->process  ( apcOriginalPicBuffer, //D'aquí recollim les dades YUV per codificar. En cas de 0 funciona, en cas de 1 només codifica 12 frames.
