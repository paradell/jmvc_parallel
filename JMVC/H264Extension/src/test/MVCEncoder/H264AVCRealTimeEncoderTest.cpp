...
#include "H264AVCRealTimeEncoderTest.h"
#include "EncoderCodingParameter.h"


H264AVCRealTimeEncoderTest::H264AVCRealTimeEncoderTest() :
...
ErrVal
H264AVCRealTimeEncoderTest::create( H264AVCRealTimeEncoderTest*& rpcH264AVCRealTimeEncoderTest )
{
  rpcH264AVCRealTimeEncoderTest = new H264AVCRealTimeEncoderTest;

  ROT( NULL == rpcH264AVCRealTimeEncoderTest );
...
ErrVal H264AVCRealTimeEncoderTest::init( Int    argc,
                                 Char** argv )
{
...
ErrVal
H264AVCRealTimeEncoderTest::destroy()
{
  m_cBinDataStartCode.reset();
...
ErrVal
H264AVCRealTimeEncoderTest::xGetNewPicBuffer ( PicBuffer*&  rpcPicBuffer,
                                       UInt         uiLayer,
                                       UInt         uiSize )
{
...
ErrVal
H264AVCRealTimeEncoderTest::xRemovePicBuffer( PicBufferList&  rcPicBufferUnusedList,
                                      UInt            uiLayer )
{
...
ErrVal
H264AVCRealTimeEncoderTest::xWrite( PicBufferList&  rcPicBufferList,
                            UInt            uiLayer )
{
...
ErrVal
H264AVCRealTimeEncoderTest::xRelease( PicBufferList&  rcPicBufferList,
                              UInt            uiLayer )
{
...
ErrVal
H264AVCRealTimeEncoderTest::xWrite( ExtBinDataAccessorList& rcList,
...
ErrVal
H264AVCRealTimeEncoderTest::xRelease( ExtBinDataAccessorList& rcList )
{
  while( rcList.size() )
  {
    delete[] rcList.front()->data();
...
ErrVal
H264AVCRealTimeEncoderTest::ScalableDealing()
{
...
//SEI {
ErrVal
H264AVCRealTimeEncoderTest::ViewScalableDealing()
{
  FILE *ftemp = fopen( m_cWriteToBitFileTempName.c_str(), "rb" );
  FILE *f     = fopen( m_cWriteToBitFileName.c_str    (), "wb" );
