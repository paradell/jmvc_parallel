#ifndef __H264AVCREALTIMEENCODERTEST_H_D65BE9B4_A8DA_11D3_AFE7_005004464B79
#define __H264AVCREALTIMEENCODERTEST_H_D65BE9B4_A8DA_11D3_AFE7_005004464B79
...
class H264AVCRealTimeEncoderTest  
{
private:
	H264AVCRealTimeEncoderTest();
	virtual ~H264AVCRealTimeEncoderTest();

public:
  static ErrVal create( H264AVCRealTimeEncoderTest*& rpcH264AVCRealTimeEncoderTest );
...
protected:
  EncoderIoParameters	           m_cEncoderIoParameter;
